        ...
        <div className="flex-1 ml-6">
          ...
          <div className="flex justify-end items-center mb-6">
            ...
            <button 
              ...
              className={`p-2 ${viewType === 'grid' ? 'text-[#f10000]' : 'text-white'}`}
            >
            ...
            <button 
              ...
              className={`p-2 ${viewType === 'list' ? 'text-[#f10000]' : 'text-white'}`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Property Grid */}
          <div className={`grid ${viewType === 'grid' ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'} gap-8`}>
